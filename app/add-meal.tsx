...
export default function AddMealScreen() {
  ...
  const [imageUrl, setImageUrl] = useState<string>(editMeal?.image_url ?? '');
  ...
  const handleSave = useCallback(() => {
    ...
    if (isEditing && editMeal) {
      updateFav(editMeal.id, {
        ...
        cooking_time_band: cookingTimeBand as FavMeal['cooking_time_band'] || undefined,
  ...
  }, [name, imageUrl, cuisine, cookingTimeBand, prepTime, cookTime, dietaryTags, customTags, mealTypeSlotId, description, chefNotes, servingSize, ingredients, methodSteps, isEditing, editMeal, updateFav, isFavByName]);
  ...
  const saveMeal = useCallback((validIngredients: Ingredient[], validSteps: string[]) => {
    ...
    Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
    router.back();
  }, [name, imageUrl, cuisine, cookingTimeBand, prepTime, cookTime, dietaryTags, customTags, mealTypeSlotId, servingSize, description, chefNotes, addFav]);
