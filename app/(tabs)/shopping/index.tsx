...
const sheetStyles = StyleSheet.create({
  ...
  chipText: { fontSize: 13, fontFamily: FontFamily.semiBold, fontWeight: '600' as const, color: Colors.text },
...
const styles = StyleSheet.create({
  ...
  weekPillText: { fontSize: 13, fontFamily: FontFamily.semiBold, fontWeight: '600' as const, color: Colors.text },
  weekPillTextActive: { color: Colors.white },
